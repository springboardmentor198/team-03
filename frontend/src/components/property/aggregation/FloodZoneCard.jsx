...
const RISK_STYLES = {
  LOW:    { ring: "ring-green-200",  bg: "bg-green-50",  text: "text-green-700",  label: "Low risk" },
  MEDIUM: { ring: "ring-amber-200",  bg: "bg-amber-50",  text: "text-amber-700",  label: "Medium risk" },
  HIGH:   { ring: "ring-red-200",    bg: "bg-red-50",    text: "text-red-700",    label: "High risk" },
};
      ...
      {flood && (
        <div className="space-y-4">
          ...
          {flood.insuranceRequired != null && (
            <div className="flex items-start gap-2 rounded-lg border border-gray-100 bg-gray-50/50 px-3 py-2.5">
              <Shield
                className={`h-4 w-4 flex-shrink-0 mt-0.5 ${
                  flood.insuranceRequired ? "text-red-500" : "text-green-600"
                }`}
                strokeWidth={2.2}
              />
              <div>
