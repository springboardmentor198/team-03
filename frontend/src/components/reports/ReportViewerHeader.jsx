...
function KebabMenu({ onDelete, onVersionHistory, onRegenerate, onClose, t }) {
  ...
  return (
    <div
      ref={menuRef}
      className="absolute right-0 top-full mt-1.5 w-52 rounded-xl border border-gray-200 dark:border-[#30363d] bg-white dark:bg-[#1c2128] shadow-xl z-50 overflow-hidden py-1"
    >
      <button
        onClick={() => { onVersionHistory(); onClose(); }}
        className="w-full flex items-center gap-3 px-4 py-2.5 text-[13px] text-gray-700 dark:text-[#e6edf3] hover:bg-gray-50 dark:hover:bg-[#21262d] transition-colors duration-150 text-left"
      >
      ...
      <button
        ...
        className="w-full flex items-center gap-3 px-4 py-2.5 text-[13px] text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/10 transition-colors duration-150 text-left"
      >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center gap-3 h-14">
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-gray-500 dark:text-[#7d8590] hover:bg-gray-100 dark:hover:bg-[#21262d] hover:text-gray-700 dark:hover:text-[#e6edf3] transition-all duration-150 flex-shrink-0 text-[13px] font-medium"
          >
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {report?.version != null && (
                <span className="text-[11px] font-bold px-2 py-0.5 rounded-full bg-gray-100 dark:bg-[#21262d] text-gray-500 dark:text-[#7d8590] flex-shrink-0">
                  v{report.version}
                </span>
              )}
              {report?.status && (
          ...
          <div className="flex items-center gap-1 flex-shrink-0">
            <button
              ...
              className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[12px] font-semibold bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 border border-blue-200 dark:border-blue-800/40 hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-all duration-150 disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {isRegenerating ? (
            ...
            <Tooltip label={t("report.viewer.actions.printShortcut")}>
              <button
                onClick={handlePrint}
                className="w-8 h-8 rounded-lg flex items-center justify-center text-gray-500 dark:text-[#7d8590] hover:bg-gray-100 dark:hover:bg-[#21262d] hover:text-gray-700 dark:hover:text-[#e6edf3] transition-all duration-150"
              >
