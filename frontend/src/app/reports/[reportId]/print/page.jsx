    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500">Preparing print view…</p>
        </div>
      </div>
    );
  }
    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-6 py-8 bg-white min-h-screen">
        ...
        <div className="no-print mb-6 flex items-center justify-between">
          <p className="text-sm text-gray-500">
            Print preview for Report #{report.id}
          </p>
          <button
        ...
        <div className="mt-8 pt-4 border-t border-gray-100 text-center">
          <p className="text-xs text-gray-400">
            Report #{report.id} · Version {report.version} · Generated by Real
            Estate Due Diligence Agent · {report.generatedByEmail}
          </p>
        </div>
      </div>
    </>
