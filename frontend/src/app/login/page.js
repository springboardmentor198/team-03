      ...
      <div className="mx-auto flex h-screen max-w-[1600px] overflow-hidden bg-white">
        ...
        <section className="flex w-full flex-col items-center bg-[#f8fffb] px-8 py-6 lg:w-[40%]">
          ...
          <div className="flex w-full max-w-[420px] flex-col">
            ...
            {/* Login Card */}
            <div className="mt-4 w-full rounded-[28px] border border-white bg-white p-5 shadow-[0_20px_60px_rgba(0,0,0,0.08)]">
              ...
              {/* Login Button */}
              <Button className="mt-4 flex h-10 w-full items-center justify-center rounded-xl bg-[#22C55E] text-sm font-bold shadow-[0_12px_30px_rgba(34,197,94,0.35)] transition-all hover:scale-[1.02] hover:bg-[#16a34a]">
                Sign In to Platform
              ...
              <div className="my-4 flex items-center">
                ...
                <span className="mx-3 text-[10px] text-gray-500">
                  OR CONTINUE WITH
                </span>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <Button variant="outline" className="h-10 rounded-xl border-gray-200 bg-white text-xs transition hover:bg-gray-50">
            ...
            <div className="mt-3 text-center text-xs text-gray-600">
              ...
              <span className="ml-1 cursor-pointer font-semibold text-green-500">
            ...
            <div className="mt-4 border-t border-gray-200 pt-3 text-[10px] uppercase tracking-widest text-gray-400">
              ...
              <p className="mt-1">
                ISO 27001 Certified • SOC2 Type II Compliant
              </p>
        ...
        <section className="relative hidden overflow-hidden rounded-l-3xl lg:block lg:w-[60%]">
          ...
          {/* Blue gradient overlay for premium look */}
          <div className="absolute inset-0 bg-gradient-to-br from-sky-900/70 via-sky-700/50 to-blue-500/40"></div>
