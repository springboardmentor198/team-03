...
public class ExportServiceImpl implements ExportService {
    ...
    public byte[] exportPropertySnapshotPdf(Long propertyId, Long userId) {
        ...
        saveAuditLog(
                ...
                "REPORT",
                propertyId,
                "Property snapshot PDF exported");
        return pdfBytes;
    }
    ...
    public byte[] exportPropertySnapshotExcel(Long propertyId, Long userId) {
        ...
        saveAuditLog(
                ...
                "REPORT",
                propertyId,
                "Property snapshot Excel exported");
        return excelBytes;
    }
    ...
    public byte[] exportBulk(ExportRequest request, Long userId) {
        ...
        try (ZipOutputStream zos = new ZipOutputStream(baos)) {
            ...
            AuditAction action = "EXCEL".equalsIgnoreCase(format)
    ...
    try {
        ...
        // Do not stop export if audit logging fails
        e.printStackTrace();
    }
}}
